...
def getTweets (keyWord, date):
    ...
    for tweet in tweets:
        ...
        try:
            tweetElement.append(tweet.place_type.name)
        except:
        ...
        tweetDict[tweetId] = tweetElement
    ...
    # tweet_text = pd.DataFrame(data=tweetsList, columns=['user', "tweet", "location", "sensitive"])
    return tweetDict



listOfData = getTweets("#cats","2017-04-03")
print(listOfData)
